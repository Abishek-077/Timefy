    ...
    <div>
            <Toolbar >
                ...
                <Typography
                    variant="h4"
                    component="h1"
                    sx={{ display: { xs: 'none', sm: 'flex' }, padding:"0 50px 0 0", color:'var(--primary)'}}
                >
                    Timefy
                </Typography>
            </Toolbar>
                ...
                {items.map((item) => (
                    ...
                    <ListItem
                        ...
                        sx={settingcontext.stateswitch ?
                             {color:"var(--offwhite)",padding:"20px 0"} : {color:"var(--text)", padding:"20px 0"}}>

                        
                            <ListItemIcon sx={settingcontext.stateswitch ?
                             {color:"var(--offwhite)",padding:"10px 0",justifyContent:"flex-end"} : {color:"var(--text)", padding:"10px 0", justifyContent:"flex-end"}}>
                                {item.icon}
                            </ListItemIcon>
